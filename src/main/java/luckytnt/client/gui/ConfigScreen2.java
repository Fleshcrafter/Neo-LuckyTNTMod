...
public class ConfigScreen2 extends Screen {
	...
	ExtendedSlider custom_tnt_first_explosion_intensity = null;
	Button custom_tnt_second_explosion = null;
	ExtendedSlider custom_tnt_second_explosion_intensity = null;
	Button custom_tnt_third_explosion = null;
	ExtendedSlider custom_tnt_third_explosion_intensity = null;
	...
	public void init() {
		...
		rows.addChild(custom_tnt_first_explosion_intensity = new ExtendedSlider(0, 0, 100, 20, Component.empty(), Component.empty(), 1, 20, LuckyTNTConfigValues.CUSTOM_TNT_FIRST_EXPLOSION_INTENSITY.get().intValue(), true));
		...
		rows.addChild(custom_tnt_second_explosion_intensity = new ExtendedSlider(0, 0, 100, 20, Component.empty(), Component.empty(), 1, 20, LuckyTNTConfigValues.CUSTOM_TNT_SECOND_EXPLOSION_INTENSITY.get().intValue(), true));
		...
		rows.addChild(custom_tnt_third_explosion_intensity = new ExtendedSlider(0, 0, 100, 20, Component.empty(), Component.empty(), 1, 20, LuckyTNTConfigValues.CUSTOM_TNT_THIRD_EXPLOSION_INTENSITY.get().intValue(), true));
	...
	public void nextExplosionValue(ModConfigSpec.EnumValue<CustomTNTConfig> config, Button button) {
	...
	public void resetExplosion(ModConfigSpec.EnumValue<CustomTNTConfig> config, Button button) {
