...
public class ConfigScreen extends Screen{
	...
	ExtendedSlider island_slider = null;
	ExtendedSlider dropped_slider = null;
	ExtendedSlider average_disaster_time_silder = null;
	ExtendedSlider average_disaster_strength_slider = null;
	...
	public void init() {
		...
		rows.addChild(island_slider = new ExtendedSlider(0, 0, 100, 20, Component.empty(), Component.empty(), 20, 160, LuckyTNTConfigValues.ISLAND_HEIGHT.get(), true));
		...
		rows.addChild(dropped_slider = new ExtendedSlider(0, 0, 100, 20, Component.empty(), Component.empty(), 60, 400, LuckyTNTConfigValues.DROP_HEIGHT.get(), true));
		...
		rows.addChild(average_disaster_time_silder = new ExtendedSlider(0, 0, 100, 20, Component.empty(), Component.empty(), 2, 24, LuckyTNTConfigValues.MAXIMUM_DISASTER_TIME.get().doubleValue(), true));
		...
		rows.addChild(average_disaster_strength_slider = new ExtendedSlider(0, 0, 100, 20, Component.empty(), Component.empty(), 1d, 10d, LuckyTNTConfigValues.AVERAGE_DIASTER_INTENSITY.get().doubleValue(), true));
	...
	public void resetIntValue(ModConfigSpec.IntValue config, int newValue, ExtendedSlider slider) {
		config.set(newValue);
		slider.setValue(newValue);
	}
	
	public void resetDoubleValue(ModConfigSpec.DoubleValue config, double newValue, ExtendedSlider slider) {
		config.set(newValue);
		slider.setValue(newValue);
	}
	...
	public void resetBooleanValue(ModConfigSpec.BooleanValue config, boolean defaultValue, Button button) {
