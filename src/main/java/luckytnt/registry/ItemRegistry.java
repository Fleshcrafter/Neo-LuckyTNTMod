...
public class ItemRegistry {
	...
	//Dynamite
	public static final DeferredItem<LDynamiteItem> DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("dynamite", EntityRegistry.DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> DYNAMITE_X5 = LuckyTNTMod.RH.registerDynamiteItem("dynamite_x5", EntityRegistry.DYNAMITE_X5, "dy");
	public static final DeferredItem<LDynamiteItem> DYNAMITE_X20 = LuckyTNTMod.RH.registerDynamiteItem("dynamite_x20", EntityRegistry.DYNAMITE_X20, "dy");
	public static final DeferredItem<LDynamiteItem> DYNAMITE_X100 = LuckyTNTMod.RH.registerDynamiteItem("dynamite_x100", EntityRegistry.DYNAMITE_X100, "dy");
	public static final DeferredItem<LDynamiteItem> DYNAMITE_X500 = LuckyTNTMod.RH.registerDynamiteItem("dynamite_x500", EntityRegistry.DYNAMITE_X500, "dy");
	public static final DeferredItem<LDynamiteItem> FIRE_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("fire_dynamite", EntityRegistry.FIRE_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> SNOW_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("snow_dynamite", EntityRegistry.SNOW_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> DYNAMITE_FIREWORK = LuckyTNTMod.RH.registerDynamiteItem("dynamite_firework", EntityRegistry.DYNAMITE_FIREWORK, "dy");
	public static final DeferredItem<LDynamiteItem> NUCLEAR_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("nuclear_dynamite", EntityRegistry.NUCLEAR_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> FREEZE_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("freeze_dynamite", EntityRegistry.FREEZE_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> FLOATING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("floating_dynamite", EntityRegistry.FLOATING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> SPHERE_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("sphere_dynamite", EntityRegistry.SPHERE_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> FLAT_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("flat_dynamite", EntityRegistry.FLAT_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> MININGFLAT_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("miningflat_dynamite", EntityRegistry.MININGFLAT_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> VAPORIZE_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("vaporize_dynamite", EntityRegistry.VAPORIZE_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> METEOR_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("meteor_dynamite", EntityRegistry.METEOR_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> CUBIC_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("cubic_dynamite", EntityRegistry.CUBIC_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> GROVE_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("grove_dynamite", EntityRegistry.GROVE_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> ENDER_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("ender_dynamite", EntityRegistry.ENDER_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> ARROW_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("arrow_dynamite", EntityRegistry.ARROW_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> LIGHTNING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("lightning_dynamite", EntityRegistry.LIGHTNING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> DIGGING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("digging_dynamite", EntityRegistry.DIGGING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> COMPACT_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("compact_dynamite", EntityRegistry.COMPACT_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> ANIMAL_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("animal_dynamite", EntityRegistry.ANIMAL_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> OCEAN_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("ocean_dynamite", EntityRegistry.OCEAN_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> SPIRAL_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("spiral_dynamite", EntityRegistry.SPIRAL_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> CHEMICAL_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("chemical_dynamite", EntityRegistry.CHEMICAL_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> REACTION_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("reaction_dynamite", EntityRegistry.REACTION_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> HELLFIRE_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("hellfire_dynamite", EntityRegistry.HELLFIRE_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> FLOATING_ISLAND_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("floating_island_dynamite", EntityRegistry.FLOATING_ISLAND_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> ERUPTING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("erupting_dynamite", EntityRegistry.ERUPTING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> SHATTERPROOF_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("shatterproof_dynamite", EntityRegistry.SHATTERPROOF_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> LAVA_OCEAN_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("lava_ocean_dynamite", EntityRegistry.LAVA_OCEAN_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> WOOL_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("wool_dynamite", EntityRegistry.WOOL_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> NUCLEAR_WASTE_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("nuclear_waste_dynamite", EntityRegistry.NUCLEAR_WASTE_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> TIMER_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("timer_dynamite", EntityRegistry.TIMER_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> GRAVITY_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("gravity_dynamite", EntityRegistry.GRAVITY_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> WITHERING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("withering_dynamite", EntityRegistry.WITHERING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> SENSOR_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("sensor_dynamite", EntityRegistry.SENSOR_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> RAINBOW_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("rainbow_dynamite", EntityRegistry.RAINBOW_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> ROULETTE_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("roulette_dynamite", EntityRegistry.ROULETTE_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> BOUNCING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("bouncing_dynamite", EntityRegistry.BOUNCING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> IGNITER_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("igniter_dynamite", EntityRegistry.IGNITER_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> MULTIPLYING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("multiplying_dynamite", EntityRegistry.MULTIPLYING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> RANDOM_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("random_dynamite", EntityRegistry.RANDOM_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> HOMING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("homing_dynamite", EntityRegistry.HOMING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> PULSE_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("pulse_dynamite", EntityRegistry.PULSE_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> PHYSICS_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("physics_dynamite", EntityRegistry.PHYSICS_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> PICKY_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("picky_dynamite", EntityRegistry.PICKY_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> CLUSTER_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("cluster_dynamite", EntityRegistry.CLUSTER_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> TUNNELING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("tunneling_dynamite", EntityRegistry.TUNNELING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> XRAY_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("xray_dynamite", EntityRegistry.XRAY_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> FARMING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("farming_dynamite", EntityRegistry.FARMING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> BIG_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("big_dynamite", EntityRegistry.BIG_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> ICE_METEOR_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("ice_meteor_dynamite", EntityRegistry.ICE_METEOR_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> HONEY_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("honey_dynamite", EntityRegistry.HONEY_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> ULTRALIGHT_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("ultralight_dynamite", EntityRegistry.ULTRALIGHT_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> ACCELERATING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("accelerating_dynamite", EntityRegistry.ACCELERATING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> NETHER_GROVE_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("nether_grove_dynamite", EntityRegistry.NETHER_GROVE_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> LUSH_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("lush_dynamite", EntityRegistry.LUSH_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> DRIPSTONE_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("dripstone_dynamite", EntityRegistry.DRIPSTONE_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> END_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("end_dynamite", EntityRegistry.END_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> CHRISTMAS_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("christmas_dynamite", EntityRegistry.CHRISTMAS_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> PRISM_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("prism_dynamite", EntityRegistry.PRISM_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> RING_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("ring_dynamite", EntityRegistry.RING_DYNAMITE, "dy");
	public static final DeferredItem<LDynamiteItem> SCULK_DYNAMITE = LuckyTNTMod.RH.registerDynamiteItem("sculk_dynamite", EntityRegistry.SCULK_DYNAMITE, "dy");
