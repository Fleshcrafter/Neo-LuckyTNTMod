...
public class Materials {
	...
	static List<TagKey<Block>> WOOD_TAGS = List.of(BlockTags.PLANKS, BlockTags.WOODEN_BUTTONS, BlockTags.WOODEN_DOORS, BlockTags.WOODEN_STAIRS, BlockTags.WOODEN_SLABS, BlockTags.WOODEN_FENCES, BlockTags.WOODEN_PRESSURE_PLATES, BlockTags.WOODEN_TRAPDOORS, BlockTags.LOGS, BlockTags.BAMBOO_BLOCKS, BlockTags.BANNERS, BlockTags.BEDS, BlockTags.ALL_SIGNS, BlockTags.BEEHIVES, BlockTags.CAMPFIRES, Tags.Blocks.BARRELS_WOODEN, Tags.Blocks.BOOKSHELVES, Tags.Blocks.CHESTS_WOODEN, Tags.Blocks.FENCE_GATES_WOODEN, Tags.Blocks.FENCES_WOODEN);
	...
	//STONE
	static List<TagKey<Block>> STONE_TAGS = List.of(BlockTags.STONE_BRICKS, BlockTags.STONE_BUTTONS, BlockTags.STONE_PRESSURE_PLATES, BlockTags.COAL_ORES, BlockTags.COPPER_ORES, BlockTags.DIAMOND_ORES,
													BlockTags.EMERALD_ORES, BlockTags.GOLD_ORES, BlockTags.IRON_ORES, BlockTags.LAPIS_ORES, BlockTags.REDSTONE_ORES, BlockTags.TERRACOTTA,
													BlockTags.BADLANDS_TERRACOTTA, BlockTags.BASE_STONE_OVERWORLD, Tags.Blocks.COBBLESTONES, Tags.Blocks.ORES, Tags.Blocks.SANDSTONE_BLOCKS,
													Tags.Blocks.SANDSTONE_RED_BLOCKS, Tags.Blocks.SANDSTONE_RED_SLABS, Tags.Blocks.SANDSTONE_RED_STAIRS, Tags.Blocks.SANDSTONE_SLABS,
													Tags.Blocks.SANDSTONE_STAIRS, Tags.Blocks.STONES, BlockTags.BASE_STONE_NETHER, BlockTags.WALLS);
