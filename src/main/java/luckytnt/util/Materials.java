...
public class Materials {
	...
	//STONE
	static List<TagKey<Block>> STONE_TAGS = List.of(Tags.Blocks.STONES, Tags.Blocks.COBBLESTONES, Tags.Blocks.ORES, BlockTags.STONE_BRICKS, BlockTags.STONE_BUTTONS, BlockTags.STONE_PRESSURE_PLATES, /*Tags.Blocks.SANDSTONE,*/ BlockTags.WALLS, BlockTags.TERRACOTTA);
