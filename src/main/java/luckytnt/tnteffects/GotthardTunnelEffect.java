...
public class GotthardTunnelEffect extends PrimedTNTEffect {
	...
	public void explosionTick(IExplosiveEntity ent) {
		if(!ent.getLevel().isClientSide()) {
			PacketDistributor.sendToPlayersTrackingEntity((Entity)ent, new ClientboundStringNBTPacket("direction", ent.getPersistentData().getString("direction"), ((Entity)ent).getId()));
			PacketDistributor.sendToPlayersTrackingEntity((Entity)ent, new ClientboundBooleanNBTPacket("streets", ent.getPersistentData().getBoolean("streets"), ((Entity)ent).getId()));
      	}
	}
